...
namespace GUI
{
    partial class ucDoanhThu
    {
        ...
        private void SetupChart(System.Windows.Forms.DataVisualization.Charting.Chart chart, string titleStr, System.Drawing.Color color)
        {
            ...
            area.AxisY.LabelStyle.Format = "{0:N0}"; // Định dạng số tiền
            ...
            series.ChartType = System.Windows.Forms.DataVisualization.Charting.SeriesChartType.Column; // Cột
